...
func testThoughtCloudLayoutScalesWithTheWindow() throws {
    ...
    try expectClose(natural.x, 151.2, "natural x")
    try expectClose(natural.y, 226.2, "natural y")
    try expectClose(natural.width, 129.6, "natural width")
    try expectClose(natural.height, 84.24, "natural height")
