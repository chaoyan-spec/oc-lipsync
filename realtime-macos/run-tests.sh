...
xcrun swiftc "$SOURCE_DIR/MouthGate.swift" "$SOURCE_DIR/WindowScale.swift" "$SOURCE_DIR/IdleAnimationPlan.swift" "$SOURCE_DIR/WaveDetector.swift" "$SOURCE_DIR/ActionCoordinator.swift" "$TEST_DIR/MouthGateTests.swift" "$TEST_DIR/WindowScaleTests.swift" "$TEST_DIR/IdleAnimationPlanTests.swift" "$TEST_DIR/WaveDetectorTests.swift" "$TEST_DIR/ActionCoordinatorTests.swift" "$TEST_DIR/main.swift" -o "$TEMP_ROOT/MouthGateTests"
